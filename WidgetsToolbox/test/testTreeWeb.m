...
%% Test Construction with Deprecated Inputs
function testConstructionArgumentsDeprecated(testCase)
...
% verifyWarningFree(testCase,fcn)
verifyWarning(testCase, fcn, ...
    'widgets:Java:DeprecatedProperty' )
...
node_1_1 = uiw.widget.TreeNode('Name','Node_1_1','Parent',node_1); %#ok<NASGU>
node_1_2 = uiw.widget.TreeNode('Name','Node_1_2','Parent',node_1);
...
w = uiw.widget.Tree('Parent',testCase.TestData.Figure);
node_1 = uiw.widget.TreeNode('Name','Node_1','Parent',w.Root);
node_1_1 = uiw.widget.TreeNode('Name','Node_1_1','Parent',node_1);
node_1_2 = uiw.widget.TreeNode('Name','Node_1_2','Parent',node_1); %#ok<NASGU>
...
verifyWarning(testCase, @()set(w,'RootVisible',true), ...
    'widgets:Java:DeprecatedProperty' )
...
verifyWarning(testCase, @()set(w,'DndEnabled',true), ...
    'widgets:Java:DeprecatedProperty' )
