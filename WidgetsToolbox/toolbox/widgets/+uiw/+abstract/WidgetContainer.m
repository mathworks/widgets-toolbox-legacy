classdef WidgetContainer < uiw.abstract.BaseContainer & ...
    ...
    properties (Constant, Hidden)
        WARNMSG = ['The add-on "Widgets Toolbox (Legacy)" is intended to ' ...
            ...
            'releases. To take advantage of the latest app building '...
            'enhancements in MATLAB, it is encouraged for existing '...
            'apps to be migrated to uifigure windows, which may require '...
            'some code updates. Please see the getting '...
